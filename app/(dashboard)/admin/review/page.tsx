    ...
    <div style={{ ...cardStyle, padding: 24, marginBottom: 16 }}>
      ...
      <div style={{ marginTop: 16, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        <div style={{ marginLeft: "auto" }}>
          <OutlineButton size="small" onClick={() => window.open(item.linkUrl, "_blank")}>
            Open in Figma
          </OutlineButton>
        </div>
      </div>
        ...
        >
          <ChevronDown
            style={{
              ...
              height: 14,
              color: "var(--color-text-tertiary)",
              transform: rubricOpen ? "rotate(0deg)" : "rotate(-90deg)",
        ...
        {review.submitted ? (
          ...
          <>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button
                ...
                style={{
                  ...
                  height: 40,
                  borderRadius: 10,
                  border: `1px solid ${review.outcome === "passed" ? "var(--color-success)" : "var(--color-success-border)"}`,
                  backgroundColor: review.outcome === "passed" ? "var(--color-success-subtle)" : "var(--color-success-subtle)",
                  color: "var(--color-success-text)",
                  fontFamily: font.body,
                  fontSize: "14.5px",
                  fontWeight: 500,
                  cursor: "pointer",
                  opacity: review.outcome === "passed" ? 1 : 0.7,
                ...
                onMouseLeave={(e) => {
                  if (review.outcome !== "passed") e.currentTarget.style.opacity = "0.7";
                }}
              >
                Pass
              </button>
              <button
                ...
                style={{
                  ...
                  height: 40,
                  borderRadius: 10,
                  border: `1px solid ${review.outcome === "needs_revision" ? "var(--color-warning)" : "var(--color-warning-border)"}`,
                  ...
                  fontWeight: 500,
                  cursor: "pointer",
                  opacity: review.outcome === "needs_revision" ? 1 : 0.7,
                  transitionProperty: "opacity, border-color",
                  transitionDuration: "var(--duration-fast)",
                  transitionTimingFunction: "var(--ease-out-quart)",
                }}
                onMouseEnter={(e) => (e.currentTarget.style.opacity = "1")}
                onMouseLeave={(e) => {
                  if (review.outcome !== "needs_revision") e.currentTarget.style.opacity = "0.7";
                }}
              >
                Needs Revision
              </button>
            ...
            <div style={{ marginTop: 16 }}>
              <PrimaryButton
                fullWidth
                disabled={!review.outcome || !review.comment.trim()}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span
                style={{
                  ...
                  fontSize: 14,
                  fontWeight: 500,
                  color: review.status === "passed" ? "var(--color-success-text)" : "var(--color-warning-text)",
                }}
              >
        ...
        <div style={{ display: "flex", gap: 0 }}>
          {(["all", "pending", "reviewed"] as const).map((f) => (
            <button
              ...
              onMouseEnter={(e) => {
                if (filter !== f) e.currentTarget.style.color = "var(--color-text-secondary)";
              }}
              onMouseLeave={(e) => {
                if (filter !== f) e.currentTarget.style.color = "var(--color-text-tertiary)";
              }}
            >
              {f}
            </button>
